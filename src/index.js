...
const router = createCommandRouter({
  ...
  'get-payment': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getPayment(core.getInput('payment-id', { required: true })))
  },
  'confirm-payment': async () => {
    const client = createClient()
    setJsonOutput('result', await client.confirmPayment(core.getInput('payment-id', { required: true }), {
      paymentMethod: optionalInput('payment-method'),
    }))
  },
  'capture-payment': async () => {
    const client = createClient()
    setJsonOutput('result', await client.capturePayment(core.getInput('payment-id', { required: true }), {
      amountToCapture: optionalNumber('amount'),
    }))
  },
  'cancel-payment': async () => {
    const client = createClient()
    setJsonOutput('result', await client.cancelPayment(core.getInput('payment-id', { required: true })))
  },
  'list-payments': async () => {
    const client = createClient()
  ...
  'get-customer': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getCustomer(core.getInput('customer-id', { required: true })))
  },
  'update-customer': async () => {
    const client = createClient()
    setJsonOutput('result', await client.updateCustomer(core.getInput('customer-id', { required: true }), {
      email: optionalInput('email'),
      name: optionalInput('name'),
      description: optionalInput('description'),
      metadata: optionalJson('metadata'),
  ...
  'delete-customer': async () => {
    const client = createClient()
    setJsonOutput('result', await client.deleteCustomer(core.getInput('customer-id', { required: true })))
  },
  ...
  'get-product': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getProduct(core.getInput('product-id', { required: true })))
  },
  'list-products': async () => {
    const client = createClient()
  ...
  'get-subscription': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getSubscription(core.getInput('subscription-id', { required: true })))
  },
  'cancel-subscription': async () => {
    const client = createClient()
    setJsonOutput('result', await client.cancelSubscription(core.getInput('subscription-id', { required: true })))
  },
  ...
  'get-invoice': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getInvoice(core.getInput('invoice-id', { required: true })))
  },
  'pay-invoice': async () => {
    const client = createClient()
    setJsonOutput('result', await client.payInvoice(core.getInput('invoice-id', { required: true })))
  },
  'list-invoices': async () => {
    const client = createClient()
  ...
  'cancel-payout': async () => {
    const client = createClient()
    setJsonOutput('result', await client.cancelPayout(core.getInput('payout-id', { required: true })))
  },
  'list-payouts': async () => {
    const client = createClient()
  ...
  'get-transfer': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getTransfer(core.getInput('transfer-id', { required: true })))
  },
  ...
  'get-dispute': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getDispute(core.getInput('dispute-id', { required: true })))
  },
  'list-disputes': async () => {
    const client = createClient()
  ...
  'get-onramp-session': async () => {
    const client = createClient()
    setJsonOutput('result', await client.getOnrampSession(core.getInput('session-id', { required: true })))
  },
